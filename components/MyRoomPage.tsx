...
export const MyRoomPage: React.FC<MyRoomPageProps> = ({ onVouchForUser }) => {
  ...
  return (
    ...
    <div className="w-full h-full flex flex-col">
      ...
      <main key={activeTab} className="flex-1 overflow-y-auto px-4 py-6">
        <div>
