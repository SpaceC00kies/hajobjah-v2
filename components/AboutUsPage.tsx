    ...
    <div className="container mx-auto p-6 sm:p-10 max-w-3xl my-8">
      <div className="bg-white dark:bg-dark-cardBg shadow-xl rounded-xl p-8 md:p-12 border border-neutral-DEFAULT dark:border-dark-border">
        ...
        <div className="space-y-5 font-serif text-neutral-dark dark:text-dark-textMuted leading-relaxed font-normal text-base sm:text-lg">
          <p>
            HAJOBJA.COM (หาจ๊อบจ้า) คือพื้นที่เล็ก ๆ สำหรับคนที่อยากใช้เวลาและทักษะที่มี ให้เกิดประโยชน์มากขึ้น หรือคนที่ต้องการโพสต์ประกาศงาน
          </p>
          <p>
            บางคนเป็นพนักงานประจำ มีเวลาว่างช่วงเย็น อยากหารายได้เพิ่มด้วยการเป็นโค้ชฟิตเนส บางคนเป็นพนักงานขายในห้าง แต่จริง ๆ ทำขนมอร่อยมาก และพร้อมส่งตามออเดอร์ หรือบางคนมีรถยนต์ และสามารถขับของไปส่งต่างจังหวัดได้เป็นครั้งคราว
          </p>
          <p>
          ...
          <ul className="list-disc list-inside space-y-2 pl-4">
            ...
            <li>คนที่มีทักษะหรือพร้อมช่วยเหลือในช่วงเวลาสั้น ๆ (ยาวก็ได้ถ้าโอเคทั้งสองฝ่าย)</li>
            <li>และพื้นที่ให้คนเจอกันโดยไม่ต้องกลัวว่าจะเลื่อนโพสต์ไม่ทัน</li>
          </ul>

          <p className="pt-2">
            ไม่ต้องเป็นบริษัท ไม่ต้องมีประวัติยืดยาว แค่มีทักษะ ความตั้งใจ และเบอร์ติดต่อ
          </p>
