...
import type { User, Job, HelperProfile, EnrichedHelperProfile, Interaction, WebboardPost, WebboardComment, UserLevel, EnrichedWebboardPost, EnrichedWebboardComment, SiteConfig, FilterableCategory, Interest, Vouch, VouchReport, BlogPost, EnrichedBlogPost, BlogComment } from './types';
    ...
    <div className="p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-x-8">
        ...
        <section className="lg:col-span-9">
          {!initialJobsLoaded && isLoadingJobs && jobsList.length === 0 && <div className="text-center py-20"><p>✨ กำลังโหลดประกาศงาน...</p></div>}
